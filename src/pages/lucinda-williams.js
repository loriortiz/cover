...
const LucindaPage = () => (
  <StaticQuery
    query={graphql`
      {
        introImage: file(relativePath: {eq: "lucinda.jpg"}) {
          childImageSharp {
            fluid(maxWidth: 650) {
...
<Caption>*From her song "Side of the Road," Lucy Jones Music (BMI), with Bug Music.</Caption>
        </Article>
      </Layout>
    )}
  />
